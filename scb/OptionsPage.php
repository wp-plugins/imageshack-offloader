...
//_____MAIN METHODS_____
	...
	function __construct($file, $options = NULL) {
		...
		add_action('admin_menu', array($this, '_page_init'));
...
//_____INTERNAL METHODS (DON'T WORRY ABOUT THESE)_____
	...
	function _page_init() {
		extract($this->args);
		$this->pagehook = add_submenu_page($parent, $menu_title, $menu_title, 8, $page_slug, array($this, '_page_content_hook'));
#		$this->pagehook = add_options_page($short_title, $short_title, 8, $page_slug, array($this, '_page_content_hook'));
